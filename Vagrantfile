...
Vagrant.configure("2") do |config|
   # config.vm.box = "u1404"
    ...
    config.vm.define :andy do |andy_config|
		# box base 
		andy_config.vm.box = "u1404"
		# network configure
        andy_config.vm.network :private_network, ip: "192.168.58.10"
        andy_config.vm.network :forwarded_port, guest: 80, host: 8080
		# andy_config.vm.network :public_network
		# share folder
		#andy_config.vm.synced_folder "../app", "/opt/app"
		#andy_config.vm.synced_folder "andy", "/home"
		#andy_config.vm.synced_folder ".", "/vagrant", disabled: true
